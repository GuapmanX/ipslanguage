...
{
    private function getOnlyEnglish(Module $instance){
        $engVals = [];
    ...
    private function getTranslatables(array $SelectedLanguages,Module $instance)
    {
        $TranslatableParts = [];
    ...
    private function updateTranslatables(array $SelectedLanguages, array $requestData, array $SupportedLanguages,Module $instance){
        foreach($SelectedLanguages as $language)
        {
            foreach($instance->GetTranslatables() as $translatable){
